...
export default function EnterpriseV20({employees}:{employees:Row[]}){
 ...
 return <div className="module-page">
  ...
  {tab==='performance'&&<Panel title="Peninjauan Kinerja"><Table rows={reviews} cols={['id_karyawan','period','score','status','catatan']}/></Panel>}
